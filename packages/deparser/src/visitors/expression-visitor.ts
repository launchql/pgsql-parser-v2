...
export class ExpressionVisitor extends BaseVisitor {
  ...
  visit(node: Node, context: DeparserContext = {}): string {
    ...
    switch (nodeType) {
      case 'A_Expr':
        return this.visitAExpr(nodeData, context);
      case 'BoolExpr':
        return this.visitBoolExpr(nodeData, context);
      case 'FuncCall':
        return this.visitFuncCall(nodeData, context);
      case 'A_Const':
        return this.visitAConst(nodeData, context);
      case 'ColumnRef':
        return this.visitColumnRef(nodeData, context);
      case 'A_ArrayExpr':
        return this.visitAArrayExpr(nodeData, context);
      case 'A_Indices':
        return this.visitAIndices(nodeData, context);
      case 'A_Indirection':
        return this.visitAIndirection(nodeData, context);
      case 'A_Star':
        return this.visitAStar(nodeData, context);
      case 'CaseExpr':
        return this.visitCaseExpr(nodeData, context);
      case 'CoalesceExpr':
        return this.visitCoalesceExpr(nodeData, context);
      case 'TypeCast':
        return this.visitTypeCast(nodeData, context);
      case 'CollateClause':
        return this.visitCollateClause(nodeData, context);
      case 'BooleanTest':
        return this.visitBooleanTest(nodeData, context);
      case 'NullTest':
        return this.visitNullTest(nodeData, context);
      case 'SubLink':
        return this.visitSubLink(nodeData, context);
      case 'CaseWhen':
        return this.visitCaseWhen(nodeData, context);
      case 'WindowDef':
        return this.visitWindowDef(nodeData, context);
      case 'SortBy':
        return this.visitSortBy(nodeData, context);
      case 'GroupingSet':
        return this.visitGroupingSet(nodeData, context);
      case 'CommonTableExpr':
        return this.visitCommonTableExpr(nodeData, context);
      case 'ParamRef':
        return this.visitParamRef(nodeData, context);
      case 'MinMaxExpr':
        return this.visitMinMaxExpr(nodeData, context);
      case 'RowExpr':
        return this.visitRowExpr(nodeData, context);
      case 'JoinExpr':
        return this.visitJoinExpr(nodeData, context);
      case 'FromExpr':
        return this.visitFromExpr(nodeData, context);
      case 'names':
        return this.visitNames(nodeData, context);
      case 'String':
  ...
  private visitAExpr(node: A_Expr, context: DeparserContext): string {
  ...
  private visitBoolExpr(node: BoolExpr, context: DeparserContext): string {
  ...
  private visitFuncCall(node: FuncCall, context: DeparserContext): string {
  ...
  private visitAConst(node: A_Const, context: DeparserContext): string {
    if (node.ival) {
  ...
  private visitColumnRef(node: ColumnRef, context: DeparserContext): string {
  ...
  private visitAArrayExpr(node: A_ArrayExpr, context: DeparserContext): string {
  ...
  private visitAIndices(node: A_Indices, context: DeparserContext): string {
    if (node.lidx) {
  ...
  private visitAIndirection(node: A_Indirection, context: DeparserContext): string {
  ...
  private visitAStar(node: A_Star, context: DeparserContext): string {
    return '*';
  }

  private visitCaseExpr(node: CaseExpr, context: DeparserContext): string {
  ...
  private visitCoalesceExpr(node: CoalesceExpr, context: DeparserContext): string {
    const args = ListUtils.unwrapList(node.args);
    const argStrs = args.map(arg => this.visit(arg, context));
    return `COALESCE(${argStrs.join(', ')})`;
  }

  private visitTypeCast(node: TypeCast, context: DeparserContext): string {
    return this.formatter.format([
  ...
  private visitCollateClause(node: CollateClause, context: DeparserContext): string {
    const output: string[] = [];
  ...
  private visitBooleanTest(node: BooleanTest, context: DeparserContext): string {
    const output: string[] = [];
    const boolContext = { ...context, bool: true };
  ...
  private visitNullTest(node: NullTest, context: DeparserContext): string {
    const output: string[] = [];
  ...
  private visitSubLink(node: any, context: DeparserContext): string {
    return this.formatter.parens(this.visit(node.subselect, context));
  }

  private visitCaseWhen(node: any, context: DeparserContext): string {
  ...
  private visitWindowDef(node: any, context: DeparserContext): string {
    const output: string[] = [];
  ...
  private visitSortBy(node: any, context: DeparserContext): string {
    const output: string[] = [];
  ...
  private visitGroupingSet(node: any, context: DeparserContext): string {
    if (node.kind === 0) {
  ...
  private visitCommonTableExpr(node: any, context: DeparserContext): string {
    const output: string[] = [];
  ...
  private visitParamRef(node: any, context: DeparserContext): string {
    return `$${node.number}`;
  }

  private visitMinMaxExpr(node: any, context: DeparserContext): string {
    const args = ListUtils.unwrapList(node.args);
    const argStrs = args.map(arg => this.visit(arg, context));
  ...
  private visitRowExpr(node: any, context: DeparserContext): string {
    const args = ListUtils.unwrapList(node.args);
    const argStrs = args.map(arg => this.visit(arg, context));
    return `ROW(${argStrs.join(', ')})`;
  }

  private visitJoinExpr(node: any, context: DeparserContext): string {
    const output: string[] = [];
  ...
  private visitFromExpr(node: any, context: DeparserContext): string {
  ...
  private visitNames(node: any, context: DeparserContext): string {
