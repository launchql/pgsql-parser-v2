...
export class UtilityVisitor extends BaseVisitor {
  ...
  visit(node: Node, context: DeparserContext = {}): string {
    ...
    switch (nodeType) {
      case 'CreateStmt':
        return this.visitCreateStmt(nodeData, context);
      case 'DropStmt':
        return this.visitDropStmt(nodeData, context);
      case 'AlterTableStmt':
        return this.visitAlterTableStmt(nodeData, context);
      case 'IndexStmt':
        return this.visitIndexStmt(nodeData, context);
      case 'ViewStmt':
        return this.visitViewStmt(nodeData, context);
      case 'CreateFunctionStmt':
        return this.visitCreateFunctionStmt(nodeData, context);
      case 'TruncateStmt':
        return this.visitTruncateStmt(nodeData, context);
      case 'CommentStmt':
        return this.visitCommentStmt(nodeData, context);
      case 'DefineStmt':
        return this.visitDefineStmt(nodeData, context);
      case 'CompositeTypeStmt':
        return this.visitCompositeTypeStmt(nodeData, context);
      case 'RenameStmt':
        return this.visitRenameStmt(nodeData, context);
      case 'AlterOwnerStmt':
        return this.visitAlterOwnerStmt(nodeData, context);
      case 'AlterObjectSchemaStmt':
        return this.visitAlterObjectSchemaStmt(nodeData, context);
      case 'DoStmt':
        return this.visitDoStmt(nodeData, context);
      case 'VariableSetStmt':
        return this.visitVariableSetStmt(nodeData, context);
      case 'VariableShowStmt':
        return this.visitVariableShowStmt(nodeData, context);
      case 'ExplainStmt':
        return this.visitExplainStmt(nodeData, context);
      case 'CreateTrigStmt':
        return this.visitCreateTrigStmt(nodeData, context);
      default:
        throw new Error(`Utility visitor does not handle node type: ${nodeType}`);
    }
  }

  private visitCreateStmt(node: CreateStmt, context: DeparserContext): string {
  ...
  private visitDropStmt(node: DropStmt, context: DeparserContext): string {
  ...
  private visitAlterTableStmt(node: AlterTableStmt, context: DeparserContext): string {
  ...
  private visitIndexStmt(node: IndexStmt, context: DeparserContext): string {
    const output: string[] = ['CREATE'];
  ...
  private visitViewStmt(node: ViewStmt, context: DeparserContext): string {
    const output: string[] = ['CREATE'];
  ...
  private visitCreateFunctionStmt(node: CreateFunctionStmt, context: DeparserContext): string {
    const output: string[] = ['CREATE'];
  ...
  private visitTruncateStmt(node: TruncateStmt, context: DeparserContext): string {
  ...
  private visitCommentStmt(node: CommentStmt, context: DeparserContext): string {
  ...
  private visitDefineStmt(node: DefineStmt, context: DeparserContext): string {
    const output: string[] = ['CREATE'];
  ...
  private visitCompositeTypeStmt(node: CompositeTypeStmt, context: DeparserContext): string {
  ...
  private visitRenameStmt(node: RenameStmt, context: DeparserContext): string {
  ...
  private visitAlterOwnerStmt(node: AlterOwnerStmt, context: DeparserContext): string {
    const output: string[] = ['ALTER'];
  ...
  private visitAlterObjectSchemaStmt(node: AlterObjectSchemaStmt, context: DeparserContext): string {
    const output: string[] = ['ALTER'];
  ...
  private visitDoStmt(node: DoStmt, context: DeparserContext): string {
  ...
  private visitVariableSetStmt(node: VariableSetStmt, context: DeparserContext): string {
  ...
  private visitVariableShowStmt(node: VariableShowStmt, context: DeparserContext): string {
  ...
  private visitExplainStmt(node: ExplainStmt, context: DeparserContext): string {
  ...
  private visitCreateTrigStmt(node: CreateTrigStmt, context: DeparserContext): string {
